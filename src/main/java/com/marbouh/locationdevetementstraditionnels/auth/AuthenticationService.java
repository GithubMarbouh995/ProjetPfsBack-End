...
import com.marbouh.locationdevetementstraditionnels.email.EmailSender;
import com.marbouh.locationdevetementstraditionnels.model.Utilisateur;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.marbouh.locationdevetementstraditionnels.config.JwtService;
...
import com.marbouh.locationdevetementstraditionnels.token.TokenType;
...
public class AuthenticationService {
  ...
  public AuthenticationResponse register(RegisterRequest request) {
    var user = Utilisateur.builder()
             ...
             .motDePasse(passwordEncoder.encode(request.getMoteDePasse()))
             .role(request.getRole())
        .build();
    var savedUser = repository.save(user);
    var jwtToken = jwtService.generateToken((UserDetails) user);
    var refreshToken = jwtService.generateRefreshToken((UserDetails) user);
    saveUserToken((Utilisateur) savedUser, jwtToken);
